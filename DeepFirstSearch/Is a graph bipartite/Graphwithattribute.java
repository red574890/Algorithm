 ...
 * @author Kevin Wayne
 */
public class Graphwithattribute {
     ...
     */
    public Graphwithattribute(int V) {
     ...
     */
    public Graphwithattribute(In in) {
     ...
     */
    public Graphwithattribute(Graphwithattribute G) {
        this.V = G.V();
        this.E = G.E();
        if (V < 0) throw new IllegalArgumentException("Number of vertices must be non-negative");
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        Graphwithattribute G = new Graphwithattribute(in);
        StdOut.println(G);
    }
